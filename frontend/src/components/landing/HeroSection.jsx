      ...
      <div className="mx-auto grid w-full max-w-6xl items-center gap-8 lg:grid-cols-2">
        ...
        >
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <Link
              to="/dashboard"
              className="rounded-full border border-orange-400/50 bg-orange-400/10 px-7 py-3 font-body text-sm font-semibold text-orange-300 transition hover:bg-orange-400/20 sm:text-base"
            >
              → Open App (temp)
            </Link>
          </div>
